...
.controller('chatController', ['$scope','Message', '$localStorage', 'usersOnline', function($scope,Message, $localStorage, usersOnline){
           ...
           //alert($scope.profile.name);
            ...
            //$rootScope.hide();
             ...
             //usersOnline  = $scope.messages.length;  // tatol online users
      			...
      			//alert(JSON.stringify($scope.allUser));
...
.controller('homeCtrl', function($scope, aksQuestion,  $ionicActionSheet, $rootScope) {
      ...
      $scope.user;
       ...
       $scope.load = function(){
			  $scope.users = JSON.parse(localStorage.getItem("userdata")) || [];
		...
		$scope.cancel = function(){
		      ...
		      $scope.submit = function(user){
			   ...
			   $scope.aksOld = JSON.parse(localStorage.getItem("userdata")) || [];
			   console.log($scope.aksOld);
               $scope.aksOld.push(JSON.stringify(user));
			   console.log(user);
			   localStorage.setItem('userdata', JSON.stringify($scope.aksOld));
