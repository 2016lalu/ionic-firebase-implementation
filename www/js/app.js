...
angular.module('starter', ['ionic','ngStorage', 'starter.controllers', 'firebase', 'ngCordova','ngStorage'])
...
. factory('Message', ['$firebase',
	function($firebase) {
		...
		var photos = $firebase(ref.child('photos'));
     ...
     console.log(photos);
		...
		var Message = {
			...
			create: function (message) {
				return photos.$add(message);
			},
			get: function (messageId) {
				return $firebase(ref.child('photos').child(messageId)).$asObject();
			},
			delete: function (message) {
				return photos.$remove(message);
			}
		};
